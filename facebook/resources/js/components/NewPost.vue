        ...
        <div class="flex justify-between items-center">
            ...
            <div>
                <button ref="postImage"
                        class="dz-clickable flex justify-center items-center rounded-full w-10 h-10 bg-gray-200 focus:outline-none">
            ...
            <div id="dz-template" class="hidden">
                <div class="dz-preview dz-file-preview mt-4">
                    <div class="dz-details">
                        ...
                        <button data-dz-remove class="textxs">REMOVE</button>
                    </div>
